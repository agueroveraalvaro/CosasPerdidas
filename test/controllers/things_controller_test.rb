...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { description: @thing.description, name: @thing.name, user_id: @thing.user_id, visits: @thing.visits } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { description: @thing.description, name: @thing.name, user_id: @thing.user_id, visits: @thing.visits } }
